...
* r2_dist: the r2 for the 5000 bootstrap samples are approximately normally distributed.The mean or mode of r2 falls around 9.1 and the variance is not large(most of data locates between 0.87 and 0.95). These suggests that a high proportion of variance in the `tmax`  can be explained by `tmin` and `prcp` included in the model.
